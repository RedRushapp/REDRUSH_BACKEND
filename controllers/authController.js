...
const register = async (req, res) => {
  try {
    const full_name = getString(req.body.full_name, req.body.fullName, req.body.name);
    const email = getString(req.body.email, req.body.emailAddress, req.body.username).toLowerCase();
    const phone = getString(req.body.phone, req.body.phoneNumber);
    const password = getString(req.body.password);
    const role = getString(req.body.role) || "customer";
